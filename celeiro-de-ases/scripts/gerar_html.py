...
.card-titulo{ font-size:12px; font-weight:600; color:var(--ink-3); letter-spacing:.04em; text-transform:uppercase; margin-bottom:14px; }
.pilula{
  display:inline-flex; align-items:center; gap:6px; padding:3px 10px; border-radius:999px;
  font-size:11.5px; font-weight:600; letter-spacing:.01em; white-space:nowrap; line-height:1.6;
}
...
.par .lbl{ font-size:11.5px; color:var(--ink-3); font-weight:400; letter-spacing:.02em }
.par .val{ font-size:17px; color:var(--ink); font-weight:600 }
...
.chip{
  ...
  padding:7px 14px; font-size:13.5px; color:var(--ink-2); white-space:nowrap;
}
.chip:hover{ border-color:var(--line-2) }
.chip .n{ font-family:"IBM Plex Mono",monospace; font-size:12px; color:var(--ink-3); font-variant-numeric:tabular-nums }
...
.avatar{
  flex:none; width:38px; height:38px; border-radius:50%; background:var(--neutro-bg); color:var(--ink-2);
...
.linha-nome{ display:block; font-size:15px; font-weight:600; color:var(--ink); overflow:hidden; text-overflow:ellipsis; white-space:nowrap }
.linha-sub{ display:block; font-size:12.5px; color:var(--ink-3); overflow:hidden; text-overflow:ellipsis; white-space:nowrap }
.linha .seta{ flex:none; color:var(--ink-3); font-size:16px }
...
.btn-voltar{
  ...
  border-radius:999px; padding:7px 14px 7px 11px; font-size:13.5px; color:var(--ink-2); cursor:pointer;
  margin-bottom:18px;
}
...
.ficha-id h2{ font-size:22px; line-height:1.2 }
.ficha-id .sub{ margin:3px 0 0; font-size:13.5px; color:var(--ink-3) }
...
@media (max-width:640px){
  ...
  .grade-kpi .val{ font-size:21px }
}
.kpi-extra{ margin-top:5px }
.nota-limite{ font-size:12.5px; color:var(--ink-2); line-height:1.55; margin:0 }
...
table.tabela th, table.tabela td{ text-align:left; padding:7px 8px; border-bottom:1px solid var(--line) }
table.tabela th{ font-size:11px; font-weight:600; color:var(--ink-3); text-transform:uppercase; letter-spacing:.04em }
...
ul.limites{ margin:0; padding-left:17px; font-size:13px; color:var(--ink-2); line-height:1.6 }
